        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="action-buttons">
                    <button class="btn-edit" data-course-id="<?php echo $row['id']; ?>">Xem chi tiết</button>
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<td>' . $stt++ . '</td>';
                                    echo '<td>' . $row['id'] . '</td>';
                                    echo "<td><img src='" . $row['image'] . "' class='course-img' alt='Ảnh khóa học'></td>";
                                    echo '<td>' . $row['course_name'] . '</td>';
                                    echo '<td>' . $row['level'] . '</td>';
                                    echo '<td>' . $row['lessons'] . ' buổi</td>';
